...
public class TextUI {
    ...
    private void addAirplane(Scanner s) {
        System.out.print("Give the airplane id: ");
    ...
    private void addFlight(Scanner s) {
        System.out.print("Give the airplane id: ");
        Airplane airplane = askForAirplane(s);
        System.out.print("Give the departure airport id: ");
        String departureID = s.nextLine();
        System.out.print("Give the target airport id: ");
        String destinationID = s.nextLine();
    ...
    private Airplane askForAirplane(Scanner s) {
        Airplane airplane = null;
        while (airplane == null) {
            String id = s.nextLine();
            airplane = flightControl.getAirplane(id);
